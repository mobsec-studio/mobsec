/* MOBSEC_JAVA_BRIDGE Frida-17 global-Java polyfill; generated */
(() => {
...
`, {
  ...
  function writeArtQuickCodePrologueX86(target2, trampoline, redirectSize) {
    Memory.patchCode(target2, 16, (code2) => {
      const writer = new X86Writer(code2, { pc: target2 });
  ...
  function writeArtQuickCodePrologueArm64(target2, trampoline, redirectSize) {
    Memory.patchCode(target2, 16, (code2) => {
      const writer = new Arm64Writer(code2, { pc: target2 });
      if (redirectSize === 16) {
